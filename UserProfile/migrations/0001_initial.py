    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.PositiveSmallIntegerField(choices=[(1, 'Period 1'), (2, 'Period 2'), (3, 'Period 3'), (4, 'Period 4'), (5, 'Period 5'), (6, 'Period 6'), (7, 'Period 7'), (8, 'Period 8'), (9, 'Period 9'), (10, 'Period 10')], verbose_name='period')),
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='UserProfile.program')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Present'), (2, 'Absent'), (3, 'Late')], verbose_name='status')),
                ('period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='UserProfile.period')),
                ...
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='taught', to=settings.AUTH_USER_MODEL)),
            ],
            options={
